                        ...
                        <div class="col-md-9 py-4 pl-lg-0">
                            ...
                            <div class="mt-0">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="spotted-times">Spotted on test <span class="spotted-count">0</span> times</div>
                                        </div>
                                        <div class="col-md-3">
                                            <button id="random_btn" class="btn  m-0 btn-outline-theme btn-rounded btn-block waves-effect z-depth-0">Random</button>
                                        </div>
                                                ...
                                                <div class="flip-card">
                                                    <div class="flip-card-inner">
                                                        ...
                                                        <div class="flip-card-front">
                                                            {!! !empty($card->image_question) ? '<div class="top-card with_img">
                                                            <img src="'.asset('uploads/'.$card->image_question).'" height="150"></div>' : '<div class="top-card"></div>' !!}
