                                    ...
                                    <table class="table mt-3">
                                        ...
                                        @if($plans->count() > 0)
                                            @foreach($plans as $pk => $plan)
                                                <tr>
                                                    <td data-title="S.No">{{ $pk + 1 }}</td>
                                                    <td data-title="Name">{{ $plan->plan }}</td>
                                                    <td data-title="Months">{{ $plan->months }} Months</td>
                                                    <td data-title="Amount">{{ $plan->amount }}</td>
                                                    <td data-title="Description">{{ $plan->description }}</td>
                                                    <td data-title="Created On">{{ $plan->created_at->format('d F, Y') }}</td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body mx-3">
                    ...
                    <div class="md-form mb-4">
                        {!! Form::select('months', ['1d' => '1 Day', '1' => '1 Month', '3' => '3 Months', '6' => '6 Months', '12' => '12 Months'], '', ['required' => 'required', 'class' => 'form-control', 'id' => 'months', 'placeholder' => 'Select Months']) !!}
